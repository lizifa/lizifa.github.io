import{c as A}from"./common-ef1b640b.js";import"./index-ec830cba.js";const n=`<h1>前端需要去了解的 nodejs 知识</h1>
<h2>node 是什么？</h2>
<ul>
...
`,l=A("intro","简介","/notes/nodejs/intro",n),u=A("tinypng","图片压缩","/notes/nodejs/tinypng",e),x=A("nodeUpdate","升级node业务代码","/notes/nodejs/nodeUpdate",t),p=A("puppeteer","网页截图&PDF生成","/notes/nodejs/puppeteer",o),f=A("cli","开发cli工具","/notes/nodejs/cli",i),j=A("npm","npm包发布","/notes/nodejs/npm",s),a=A("pm2","pm2使用","/notes/nodejs/pm2",r),c=[j,f,a,u,p,x],Y=A("intro","node-js","/notes/nodejs/intro",n,c);export{l as __default,Y as __module,f as cli,c as default,x as nodeUpdate,j as npm,c as page,a as pm2,p as puppeteer,u as tinypng};
